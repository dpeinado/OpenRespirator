...
void MonitorMsgForcedSend (monStateT state){
    ...
    if (trfError != I2C2_BUSY) {
        ...
        monitorMsg[6] = LowVAlarm>>1;
        if (chLowVAlarm){
            monitorMsg[6] |= 0x80;
        }

        monitorMsg[7] = HighVAlarm>>1;
        if (chHighVAlarm){
            monitorMsg[7] |= 0x80;
        }
...
# 958 "main.c"
            ...
            if ((((uint24_t) 3000*intMaxV)/effectiveFlowRate) < 500) {
                ...
                pInspVSet = 1;
                printf ("\nVLow\n");
            } else if ((((uint24_t) 1500*intMaxV)/effectiveFlowRate) < 500) {
                LATAbits.LATA2 = 0;LATCbits.LATC3 = 1;
                        ...
                        if (timeElapsedR(&rCycleTime, intIDuration-rSV2ValveCRT-((time_t) 20*1)) ||
                            ...
                            if ((pInst > intMaxP) || ((pCtrl + pInspOSScale) > intMaxP)) {
                                ...
                                if ((pInspVSet == 2) || (pInspVSet == 3)) {
                                    ...
                                    if (timeElapsed(rVMedActuationTstamp, rSV2ValveCRT+((time_t) 15*1))) {
                ...
                if (timeElapsedR(&rCycleTime, intEDuration)) {
                    ...
                    if (initExpSubState) {
                        ...
                        if ((LATAbits.LATA2|LATCbits.LATC3) && (timeElapsedR(&rValveActuationTstamp, ((time_t) 15*1)) || (pInst > intMaxP))) {
                            ...
                            if (OSCheck) {
                                if (timeElapsed(rValveActuationTstamp, ((time_t) 350*1) + rSV2ValveCRT+((time_t) 15*1))) {
