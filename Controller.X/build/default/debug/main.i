    ...
    if (1) {
        ...
        while (1){
            ...
            if (timeElapsedR(&printTime, ((time_t) 20*1))) {
                ...
                printf ("VP %d SVP %d, SQRT %d. Volume %d\n", auxP, v1, v2, volume);
        ...
        while (1) {
            ...
            while (1) {
                ...
                if (timeElapsedR(&printTime, ((time_t) 20*1))) {
                    ...
                    aCaptGetResult(AuxPSensor, &auxP);
                    pNext = rPressurePredict(rSV2ValveDelay, pInst, pAvgShort);
                    printf ("PI T %d - Pi %d Pn %d Pd %d. R %d Pip %d OS %d. VP %d\n", timeDiff(rValveDelayStart,timeGet()), (10*pInst)/((int16_t) 45*1), (10*(pNext))/((int16_t) 45*1), (10*(pInst-pAvgShort))/((int16_t) 45*1), rSV2ValveDelay, (10*pPlateau)/((int16_t) 45*1), (10*pInspOS)/((int16_t) 45*1), auxP);
# 299 "main.c"
                }
                        ...
                        if (aCaptGetResult(MainPSensor, &pInst)) {
                            if (0) {
                                ...
                                if ((pNext < ((int16_t) 45*PEEP)) || (pInst < ((int16_t) 45*PEEP))) {
                                    ...
                                    OSCheck = 1;
                                    printf ("PEI end T %d - Pi %d Pn %d\n", timeDiff(rValveDelayStart,rValveAcuationTstamp),(10*pInst)/((int16_t) 45*1), (10*pNext)/((int16_t) 45*1));
                                }
                            } else {
